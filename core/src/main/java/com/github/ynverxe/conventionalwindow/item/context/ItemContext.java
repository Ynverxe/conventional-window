...
/**
 * Used to expose data to {@link com.github.ynverxe.conventionalwindow.item.MenuItem} related logic. This class is created every tick on {@link SimpleMenu#tick()} or when an item click event is called.
